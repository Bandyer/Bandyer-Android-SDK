...
## News 1.5.x
- 2020-10-08: Bandyer-Android-SDK 1.5.8 has been released. Improved UI/UX and fixed minor bugs. For other changes read the [release notes](https://github.com/Bandyer/Bandyer-Android-SDK/releases/tag/v1.5.8).
